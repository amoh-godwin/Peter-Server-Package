# -*- coding: utf-8 -*-
"""
Created on Wed Sep 11 13:05:13 2019
...
mime_app_aux_name = {'pdf': 'pdf', 'js': 'javascript', 'json': 'json',
                     'atom': 'atom+xml'}
mime_app_type = [
        'json', 'javascript', '1d-interleaved-parityfec',
...
mime_video_aux_name = {'mov': "quicktime"}

mime_video_type = [
                'mp4', 'mpeg', 'ogg', 'raw', '3gpp', '3gpp2'
                ...
                'jpeg2000', 'mj2', 'MP1S', 'MP2P', 'MP2T', 'MP4V-ES',
                'mpeg4-generic', 'nv', 'parityfec',
                'pointer', 'quicktime', 'raptorfec', 'rtp-enc-aescm128',
...
mime_text_aux_name = {'html': 'html', 'txt': 'plain'}

mime_text_type = [
                '1d-interleaved-parityfec', 'css','csv', 'xml', 'html',
                'cache-manifest', 'calendar', 'csv-schema',
                'dns', 'encaprtp', 'enriched',
                'example', 'flexfec', 'fwdred', 'grammar-ref-list',
                ...
                'vnd.wap.wml', 'vnd.wap.wmlscript',
                'xml-external-parsed-entity']

mime_message_aux_name = {'wsc': 'vnd.wfa.wsc'}
mime_message_type = [
...
mime_multipart_aux_name = {'x-mixed-replace': 'x-mixed-replace'}
mime_multipart_type = [
...
mime_model_aux_name = {'x3d': 'x3d+xml'}
mime_model_type = [
...
mime_audio_aux_name = {'m4a': 'MP4A-LATM'}
mime_audio_type = [
...
mime_font_aux_name = {'collection': 'collection'}
mime_font_type = ['collection', 'otf', 'sfnt', 'ttf', 'woff', 'woff2']
